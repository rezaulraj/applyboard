      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="relative w-full max-w-lg mx-auto">
              ...
              <div className="absolute bottom-0 left-14 z-10 w-64 bg-white rounded-2xl shadow-lg border border-pink-100 p-4 animate-float-slow hover:shadow-xl transition-shadow duration-300">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <p className="text-xs font-semibold text-gray-900 font-sans leading-tight">
          ...
          <div className="space-y-6 order-1 md:order-2">
            ...
            <div className="space-y-4">
              <p className="text-base sm:text-lg font-sans text-gray-600 leading-relaxed">
                <span className="text-blue-600 font-semibold">
                  Search 150,000+ programs
                </span>{" "}
                by location, start date, tuition, and more—for free. Our
                comprehensive AI will help guide you with personalized results
            ...
            <button
              onClick={() => setPopupOpen(true)}
              className="inline-flex items-center gap-2 font-sans text-base lg:text-lg bg-blue-600 hover:bg-blue-700 text-white font-semibold px-8 py-4 rounded-xl transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/25 hover:-translate-y-0.5"
            >
              Start Searching
              <svg
