...
const HomePage = () => {
  ...
  return (
    <div ref={containerRef} className="home-page-container relative">
      {/* 📈 Scroll Progress Bar */}
      <div
        ref={progressRef}
        className="fixed top-0 left-0 right-0 h-1 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 origin-left z-50 scale-x-0"
