...
const PrivacyPolicy = () => {
  ...
  useGSAP(
    () => {
      ...
      // Animate the table of contents sidebar
      gsap.fromTo(
        ".toc-sidebar",
        { opacity: 0, x: -30 },
        {
  ...
  return (
    ...
    >
      ...
      <div
        ref={progressRef}
        className="fixed top-0 left-0 right-0 h-1 bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 z-50 scale-x-0"
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-64 flex-shrink-0">
            <div className="toc-sidebar sticky top-24 bg-white rounded-2xl shadow-lg p-6 border border-blue-100">
          ...
          <div className="flex-1 bg-white rounded-2xl shadow-lg p-8 sm:p-12 border border-blue-100">
            <section id="introduction" className="mb-12 scroll-mt-24">
              ...
              <div className="prose prose-lg max-w-none text-gray-600 leading-relaxed space-y-4">
                <p className="gsap-child">
                  Welcome to AdmissionOnBoard. We are committed to protecting
                  your privacy and ensuring you have a positive experience when
                  using our website and services. This Privacy Policy explains
                ...
                <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded-r-lg mt-4 gsap-child">
            ...
            <section id="information" className="mb-12 scroll-mt-24">
              ...
              <div className="space-y-6">
                <div className="bg-gray-50 rounded-xl p-6 gsap-child">
            ...
            <section id="use" className="mb-12 scroll-mt-24">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                {[
                  ...
                  <div
                    key={index}
                    className="flex items-center gap-3 bg-blue-50 rounded-lg p-4 gsap-child"
                  >
                    <svg
            ...
            <section id="sharing" className="mb-12 scroll-mt-24">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                ...
                <div className="space-y-4">
                  <div className="border-l-4 border-blue-500 pl-4 gsap-child">
                    <h4 className="font-semibold text-gray-900 mb-2">
                      Universities and Educational Institutions
                    </h4>
                    <p>
                      We share your application information with universities
                      and colleges you apply to through our platform.
                    </p>
                  </div>
                  <div className="border-l-4 border-blue-500 pl-4 gsap-child">
                    <h4 className="font-semibold text-gray-900 mb-2">
                    ...
                    <p>
                      We may share information with third-party vendors who
            ...
            <section id="cookies" className="mb-12 scroll-mt-24">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 space-y-4 gsap-child">
            ...
            <section id="security" className="mb-12 scroll-mt-24">
              ...
              <div className="space-y-4">
                <p className="text-gray-600 leading-relaxed gsap-child">
                ...
                <div className="grid gap-4 sm:grid-cols-3">
                  <div className="bg-green-50 border border-green-200 rounded-xl p-4 text-center gsap-child">
                    <svg
              ...
              <div className="grid gap-4">
                {[
                  ...
                  },
                  {
                    ...
                    desc: "Request transfer of your data to another service",
                  },
                  {
                    title: "Object",
                  ...
                  <div
                    key={index}
                    className="flex items-start gap-4 bg-gradient-to-r from-blue-50 to-white rounded-xl p-5 border border-blue-100 hover:shadow-md transition-shadow gsap-child"
                  >
            ...
            <section id="international" className="mb-12 scroll-mt-24">
              ...
              <div className="bg-indigo-50 rounded-xl p-6 space-y-4 gsap-child">
                <p className="text-gray-700">
                ...
                <p className="text-gray-700">
                  We take all steps reasonably necessary to ensure that your
                  data is treated securely and in accordance with this Privacy
                  Policy and no transfer of your personal data will take place
                  to an organization or a country unless there are adequate
                  controls in place including the security of your data and
                  other personal information.
                </p>
                <div className="flex flex-wrap gap-2 mt-4">
                  {["Canada", "USA", "UK", "Australia", "Germany", "India"].map(
                    (country) => (
                      <span
                        key={country}
                        className="px-3 py-1 bg-white text-indigo-600 rounded-full text-sm font-medium border border-indigo-200"
                      >
                        {country}
                      </span>
                    ),
            ...
            <section id="children" className="mb-12 scroll-mt-24">
              ...
              <div className="bg-amber-50 border-l-4 border-amber-500 rounded-r-xl p-6 gsap-child">
                <p className="text-gray-700 leading-relaxed">
                  Our services are not intended for individuals under the age of
                  16. We do not knowingly collect personal information from
                  children under 16. If you are a parent or guardian and you are
            ...
            <section id="changes" className="mb-12 scroll-mt-24">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-blue-100 rounded-lg p-4 mt-4 gsap-child">
            ...
            <section id="contact" className="mb-12 scroll-mt-24">
              ...
              <div className="bg-gradient-to-br from-blue-600 to-blue-800 rounded-2xl p-8 text-white gsap-child">
