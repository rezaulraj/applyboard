      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center md:items-start">
        ...
        <div className="flex flex-col gap-6 col-span-7 order-1 md:order-2">
          ...
          <p className="text-gray-600 text-base font-sans lg:text-lg leading-relaxed">
            ...
            stepping stone to an exciting lifelong career, and Ireland offers
            just that. Since Ireland is a burgeoning tech hub, it’s a perfect
            place for students in engineering or technology to kickstart their
            careers!
          </p>

          <p className="text-gray-600 text-base font-sans lg:text-lg leading-relaxed">
            Full-time international students can work up to 20 hours per week
            during their study term. And students with a valid immigration Stamp
            2 are also allowed to work up to 40 hours per week from June through
            September, and over the winter break!
          </p>
          <p className="text-gray-600 text-base font-sans lg:text-lg leading-relaxed">
            Then, after your studies end, the third level graduate programme
            allows some international students to remain in Ireland and work for
            up to twelve months after graduation. In certain cases, this can be
            renewed for an additional 12 months, giving you more opportunities
            to work and live in the Emerald Isle.
          </p>
...
export default ExperienceIreland;
