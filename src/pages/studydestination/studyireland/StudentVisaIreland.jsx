    ...
    <div className="max-w-6xl mx-auto px-6 py-16 flex flex-col gap-14">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-14 items-center">
        ...
        <div className="flex flex-col gap-5 col-span-7">
          ...
          <p className="text-gray-600 text-base font-sans lg:text-lg leading-relaxed">
            If so, you may not need to apply for a student visa at all. You will
            still need to show other documents when arriving in Ireland, though.{" "}
            <a>ImmiAccount system</a>. You can only apply for your Australian
            student visa after enrolling in a course of study, paying your
            enrollment deposit, and receiving your Electronic Confirmation of
            Enrollment (eCoE).
          </p>

          <h3 className="text-lg sm:text-xl font-montserrat font-semibold text-gray-800 leading-tight">
            Average Visa Cost: €60.00
          </h3>
        </div>
      ...
      {/* Bottom: CTA Banner */}
      <div className="relative rounded-2xl bg-gradient-to-br from-teal-900 via-teal-700 to-teal-500 px-12 py-14 grid grid-cols-1 lg:grid-cols-2 items-center min-h-[220px]">
        {/* Decorative rings */}
        ...
        <div className="relative z-30 flex flex-col gap-4">
          <h3 className="text-4xl font-bold font-montserrat text-white leading-tight">
            ...
            <br />
            Achieve <span className="text-teal-500">Your Dreams</span>
          </h3>
...
export default StudentVisaIreland;
