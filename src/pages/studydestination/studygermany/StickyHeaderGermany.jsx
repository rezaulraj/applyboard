...
import AcademicsGermany from "./AcademicsGermany";
import SatisfactionGermany from "./SatisfactionGermany";
import ExperienceGermany from "./ExperienceGermany";
import AffordabilityGermany from "./AffordabilityGermany";
import CommunityGermany from "./CommunityGermany";

const StickyHeaderGermany = () => {
  ...
  const sections = [
    ...
    },
    {
      ...
      color: "bg-orange-500",
      hasCustom: true,
      component: AffordabilityGermany,
    },
    {
      id: "community",
      label: "COMMUNITY",
        ...
        <div className="bg-white/80 backdrop-blur-md">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-montserrat font-bold text-center text-gray-800 mb-5">
              5 Incredible Reasons to Study in Germany
            </h2>
...
export default StickyHeaderGermany;
