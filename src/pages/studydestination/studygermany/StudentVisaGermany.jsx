      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-14 items-center">
        ...
        <div className="flex flex-col gap-5 col-span-7">
          ...
          <p className="text-gray-600 text-base font-sans lg:text-lg leading-relaxed">
            After getting a letter of admission from a German higher education
            institution, you’ll need to apply for an{" "}
            <a
              href="#"
            ...
            : either a Student Visa (the standard), a Student Applicant Visa
            (needed in some cases, if your institution requires an in-person
            entrance exam), or a Language Course Visa (for students taking an
