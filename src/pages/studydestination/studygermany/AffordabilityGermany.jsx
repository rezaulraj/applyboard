      ...
      <div className="relative w-full py-10 rounded-4xl mt-10 flex items-center justify-center overflow-hidden bg-blue-900">
        ...
        <div className="relative z-10 text-center text-gray-100 p-8 max-w-2xl">
          ...
          <p className="text-base mb-4 font-sans">
            Germany’s tuition fees range from almost nothing up to many thousands of euros, depending on many factors. Public universities are usually lower-cost or even tuition-free, and private universities have plenty of affordable programmes as well, depending on what you’d like to study and at what level.
          </p>
        </div>
      </div>
    </div>
...
export default AffordabilityGermany;
