...
const StudentVisaUsa = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-16 flex flex-col gap-14">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-14 items-center">
        <div className="flex flex-col gap-5 col-span-7">
          ...
          <p className="text-gray-600 text-base font-sans lg:text-lg leading-relaxed">
            To study in the US, most students will apply for an F-1 student
            visa, which is reserved for students planning to study at a college
            or university in the US (or planning to study English at an English
            language institute).
          </p>
          <p className="text-gray-600 text-base font-sans lg:text-lg leading-relaxed">
            After being accepted by an approved school in the United States,
            you’ll be registered for the Student and Exchange Visitor
            Information System (SEVIS) and must pay the I-901 fee. Your school
            will issue you a Form I-20 to complete. After completing these
            steps, you can apply at a US Embassy or Consulate to take your F or
            M student visa interview.
          </p>
      ...
      <div className="relative rounded-2xl bg-gradient-to-br from-amber-900 via-amber-700 to-amber-500 px-12 py-14 grid grid-cols-1 lg:grid-cols-2 items-center min-h-[220px]">
        ...
        <div className="relative z-30 flex flex-col gap-4">
          <h3 className="text-4xl font-bold font-montserrat text-white leading-tight">
            Study in the USA and
            <br />
            Achieve <span className="text-amber-500">Your Dreams</span>
          </h3>
