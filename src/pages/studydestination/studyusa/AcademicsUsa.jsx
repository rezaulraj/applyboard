  ...
  const featuredPrograms = [
    {
      ...
      program: "Master of Professional Studies - Analytics",
      image:
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
          ...
          <div className="space-y-6 col-span-7 order-1 md:order-2">
            ...
            <p className="text-gray-600 text-base lg:text-lg font-sans leading-relaxed">
              Known for its academic excellence, the United States boasts one of
              the very best university systems on the planet.
            </p>

            <p className="text-gray-600 text-base lg:text-lg font-sans leading-relaxed">
              A significant majority of the world’s top-rated universities are
              located in the USA, and the country’s many acclaimed colleges,
              universities, and technical institutes are revered worldwide for
              their quality. Graduates from American institutions can often
              leverage that expertise to work and live anywhere in the world. If
              you’re ready to compete to be one of the best of the best in your
              field, an American education might just be your ticket.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-10">
            <h3 className="text-2xl sm:text-3xl font-bold text-gray-900 font-montserrat">
              Explore Some of the USA’s Top Study Programs
            </h3>
