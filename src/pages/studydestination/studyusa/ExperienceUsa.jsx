...
const ExperienceUsa = () => {
  return (
    <section className="py-16 px-6 max-w-6xl mx-auto">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-22 items-center md:items-start">
        {/* Images Column */}
        <div
        ...
        <div className="flex flex-col gap-6 col-span-7 order-1 md:order-2">
          ...
          <p className="text-gray-600 text-base font-sans lg:text-lg leading-relaxed">
            ...
            stepping stone to an exciting lifelong career. Thankfully, in the
            USA, many study programs offer real practical training elements,
            helping you get crucial early experience working in your specific
            field.
          </p>

          <p className="text-gray-600 text-base font-sans lg:text-lg leading-relaxed">
            In their first year of studies, F-1 visa students may work on-campus
            for up to 20 hours per week during regular full-time semesters.​
            Then, students who find work in their particular field may exercise
            OPT (Optional Practical Training) for up to 12 months before and/or
            after finishing their academic program without getting a new visa.
            Plus, graduates from STEM programs are eligible for an extension of
