  ...
  const featuredPrograms = [
    {
      ...
      program: "Master of Laws - Corporate Law",
      image:
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
          ...
          <div className="space-y-6 col-span-7 order-1 md:order-2">
            ...
            <p className="text-gray-600 text-base lg:text-lg font-sans leading-relaxed">
              The United Kingdom’s many prestigious universities and institutes
              are recognized around the world for their quality and innovation.
              The country is home to many of the English-speaking world’s oldest
              and most historic universities, making the UK an important
              birthplace of modern academia. Therefore, graduates from academic
              institutions in the UK have a certain air of status, and are
              considered to be deeply exceptional and in demand by top employers
              around the world.
            </p>

            <p className="text-gray-600 text-base lg:text-lg font-sans leading-relaxed">
              The UK’s universities also rank highly among the world’s very best
              on global lists. If you’re looking for a premium academic
              education that will challenge you and help you grow as a lifelong
              learner and a professional, pursue an education in the UK!
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-10">
            <h3 className="text-2xl sm:text-3xl font-bold text-gray-900 font-montserrat">
              Explore Some of the UK’s Top Study Programs
            </h3>
            <button
