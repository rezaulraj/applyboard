      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center md:items-start">
        ...
        <div className="flex flex-col gap-6 col-span-7 order-1 md:order-2">
          ...
          <p className="text-base lg:text-lg font-sans text-gray-500 leading-relaxed">
            ...
            stepping stone to an exciting lifelong career. Australia offers
            generous work-while-studying rules to help you fund your studies and
            build connections. Many study programs also offer co-op and
            internship elements, helping you get crucial early experience in
            your specific field.
          </p>

          <p className="text-base lg:text-lg font-sans text-gray-500 leading-relaxed">
            Under normal circumstances, Australia allows international students
            to work up to 48 hours per fortnight (every two weeks) while
            studying. After graduation, you may qualify for Australia's
            Temporary Graduate Visa (subclass 485) — also known as a post-study
            work visa.
          </p>
          ...
          <div className="flex flex-wrap gap-4 mt-2">
            ...
            <div className="flex items-center justify-between gap-4 flex-1 min-w-[160px] bg-white border border-gray-100 rounded-2xl px-5 py-4 shadow-sm hover:shadow-md transition-shadow">
              <div>
                ...
                <p className="text-xl font-semibold text-gray-900 font-montserrat">48 Hrs</p>
                <p className="text-xs text-gray-400 font-sans">every 2 weeks</p>
              </div>
            ...
            <div className="flex items-center justify-between gap-4 flex-1 min-w-[160px] bg-white border border-gray-100 rounded-2xl px-5 py-4 shadow-sm hover:shadow-md transition-shadow">
              <div>
                <p className="text-xs text-gray-400 mb-1 font-sans">Work After Study</p>
                <p className="text-xl font-semibold text-gray-900 font-montserrat">
                  1 to 3 Years
                </p>
                <p className="text-xs text-gray-400 font-sans">post-study visa</p>
              </div>
              <button className="w-8 h-8 rounded-full bg-blue-600 hover:bg-blue-700 flex items-center justify-center transition-colors flex-shrink-0">
                <svg
                  className="w-3.5 h-3.5 text-white"
